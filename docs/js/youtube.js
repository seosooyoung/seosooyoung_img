(function($){
    ...
    (function handleTrailer5(){
        // 셀럭터 캐시
        var $selector = {
            body: $( "body" ),
            overlay: $( "#blackout" ),
            modal: $( "#trailerModal" ),
            showButton: $( "#showTrailer5" ),
        ...
        function setPlayer5( id ){
            player.obj = new YT.Player( "trailer5", {
                width: 480,
                height: 282,
                videoId: id,    
        ...
        function showPlayer() {
            if ( !player.obj ) {
                setPlayer5( $selector.showButton.data("youtube5") );
            }
    ...
    (function handleTrailer4(){
        // 셀럭터 캐시
        var $selector = {
            body: $( "body" ),
            overlay: $( "#blackout" ),
            modal: $( "#trailerModal" ),
            showButton: $( "#showTrailer4" ),
            hideButton: $( "#hideTrailer" ),
        };
        ...
        //YouTube API를 이용해 iframe을 생성
        function setPlayer4( id ){
            player.obj = new YT.Player( "trailer4", {
                width: 480,
                height: 282,
                videoId: id,    
                playerVars: player.query
        ...
        function showPlayer() {
            if ( !player.obj ) {
                setPlayer4( $selector.showButton.data("youtube4") );
            }
